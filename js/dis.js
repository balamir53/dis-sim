...
dis.RangeCoordinates = function(lat, lon, alt)
{
    ...
    //this.ENUOriginInECEF = dis.RangeCoordinates.prototype.latLonAltDegreesToECEF(lat, lon, alt);
};
...
dis.CollisionElasticPdu = function()
{
   ...
   /** This field shall represent the degree to which eigy is conserved in a collision */
